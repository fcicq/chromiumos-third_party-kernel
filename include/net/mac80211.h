 ...
 * the frames pending in lower layer (firmare) txq.
 *
 * Register the estimated airtime for the frames released to firmware. The
 * pending airtime is used to limit txq size (in airtime) in lower layer.
 *
...
/**
 * ieee80211_txq_airtime_limit_check - check if the airtime based queue limit
 * has been reached.
 * @hw: pointer obtained from ieee80211_alloc_hw()
 ...
 */
bool
ieee80211_txq_airtime_limit_check(struct ieee80211_hw *hw,
				  struct ieee80211_txq *txq);
