...
static int ov13858_update_analog_gain(struct ov13858 *ov13858, u32 a_gain)
{
	 return ov13858_write_reg(ov13858, OV13858_REG_ANALOG_GAIN,
				OV13858_REG_VALUE_16BIT, a_gain);
}

static int ov13858_update_exp_time(struct ov13858 *ov13858, u32 exp_time)
{
...
static int ov13858_update_vblank(struct ov13858 *ov13858, u32 vblank)
{
	return ov13858_write_reg(ov13858, OV13858_REG_VTS,
				OV13858_REG_VALUE_16BIT,
				ov13858->cur_mode->height + vblank);
}
...
static int ov13858_update_digital_gain(struct ov13858 *ov13858, u32 d_gain)
{
	...
	ret = ov13858_write_reg(ov13858, OV13858_REG_DIGITAL_GAIN,
				OV13858_REG_VALUE_08BIT, val);
...
static int ov13858_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_ANALOGUE_GAIN:
		ret = ov13858_update_analog_gain(ov13858, ctrl->val);
		break;
	case V4L2_CID_GAIN:
		ret = ov13858_update_digital_gain(ov13858, ctrl->val);
		break;
	case V4L2_CID_EXPOSURE:
		ret = ov13858_update_exp_time(ov13858, ctrl->val);
		break;
	case V4L2_CID_VBLANK:
		ret = ov13858_update_vblank(ov13858, ctrl->val);
		break;
...
static int ov13858_init_controls(struct ov13858 *ov13858)
{
	...
	ov13858->analog_gain = v4l2_ctrl_new_std(
				ctrl_hdlr, &ov13858_ctrl_ops,
				V4L2_CID_ANALOGUE_GAIN, OV13858_ANA_GAIN_MIN,
				OV13858_ANA_GAIN_MAX, OV13858_ANA_GAIN_STEP,
				OV13858_ANA_GAIN_DEFAULT);

	/* Digital gain */
	ov13858->digital_gain = v4l2_ctrl_new_std(
					ctrl_hdlr, &ov13858_ctrl_ops,
					V4L2_CID_GAIN, OV13858_DGTL_GAIN_MIN,
