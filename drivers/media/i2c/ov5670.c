...
/* Group access */
#define OV5670_REG_GROUP_ACCESS		0x3208
#define OV5670_GROUP_HOLD_START(g_id)	(0x00 | (g_id))
#define OV5670_GROUP_HOLD_END(g_id)	(0x10 | (g_id))
#define OV5670_GROUP_LAUNCH(g_id)	(0xa0 | (g_id))
#define OV5670_GROUP_FAST_LAUNCH(g_id)	(0xe0 | (g_id))
...
#define	OV5670_EXPOSURE_MAX		65535
...
static int ov5670_update_analog_gain(struct ov5670 *ov5670, u32 a_gain)
{
...
static int ov5670_update_exp_time(struct ov5670 *ov5670, u32 exp_time)
{
...
static int ov5670_update_vblank(struct ov5670 *ov5670, u32 vblank)
{
	return ov5670_write_reg(ov5670, OV5670_REG_VTS,
			   OV5670_REG_VALUE_16BIT,
			   ov5670->cur_mode->height + vblank);
}
...
static int ov5670_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_ANALOGUE_GAIN:
		ret = ov5670_update_analog_gain(ov5670, ctrl->val);
		break;
	case V4L2_CID_GAIN:
		ret = ov5670_update_digital_gain(ov5670, ctrl->val);
		break;
	case V4L2_CID_EXPOSURE:
		ret = ov5670_update_exp_time(ov5670, ctrl->val);
		break;
	case V4L2_CID_VBLANK:
		ret = ov5670_update_vblank(ov5670, ctrl->val);
		break;
...
static int ov5670_init_controls(struct ov5670 *ov5670)
{
	...
	ov5670->analog_gain = v4l2_ctrl_new_std(ctrl_hdlr, &ov5670_ctrl_ops,
	...
	/* Digital gain */
	ov5670->digital_gain = v4l2_ctrl_new_std(ctrl_hdlr, &ov5670_ctrl_ops,
						 V4L2_CID_GAIN,
