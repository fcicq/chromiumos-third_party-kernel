...
static const __initconst struct x86_cpu_id cpu_vuln_whitelist[] = {
	...
	VULNWL_INTEL(ATOM_SILVERMONT1,		NO_SSB | NO_L1TF | MSBDS_ONLY),
	VULNWL_INTEL(ATOM_SILVERMONT2,		NO_SSB | NO_L1TF | MSBDS_ONLY),
	VULNWL_INTEL(ATOM_MERRIFIELD,		NO_SSB | NO_L1TF | MSBDS_ONLY),
	...
	VULNWL_INTEL(ATOM_MOOREFIELD,		NO_L1TF | MSBDS_ONLY),
